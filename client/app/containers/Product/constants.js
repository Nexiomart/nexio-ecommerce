...
export const FETCH_TOP_DISCOUNTED_PRODUCTS = 'src/Product/FETCH_TOP_DISCOUNTED_PRODUCTS';
export const FETCH_LATEST_PRODUCTS = 'src/Product/FETCH_LATEST_PRODUCTS';
